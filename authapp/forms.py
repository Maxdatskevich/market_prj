...
# Форма = связь юзера с таблицей в БД
...
class TravelUserRegisterForm(UserCreationForm):
    ...
    # Проверка соответсиивя поля требованиям "clean_поле"
    def clean_age(self):
...
# форма редактировнаия стандартных данных
...
# форма редактирвоания расширенного профиля
